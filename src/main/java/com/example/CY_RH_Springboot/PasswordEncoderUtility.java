...
public class PasswordEncoderUtility {
    public static void main(String[] args) {
        ...
        String hashPwd = encoder.encode("pwd123");
        ...
        System.out.println();
        System.out.println("-- Pour tous les autres (mot de passe: pwd123)");
        ...
        System.out.println("'pwd123' correspond au hash: " + encoder.matches("pwd123", hashPwd));
        System.out.println();
